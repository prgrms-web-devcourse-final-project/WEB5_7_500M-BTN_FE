...
import { useOwnerShops, useCreateShop } from "@/api/hooks";
...
const MyShopPage = () => {
  ...
  const { data: ownerShopsData, isLoading, error } = useOwnerShops();
  const createShopMutation = useCreateShop();

  const myShop = ownerShopsData?.data?.shopItem?.[0];
                ...
                <Stack spacing={3}>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            category: e.target
                              .value as ShopCreateRequestCategoryEnum,
                          })
                        }
                      >
                        ...
                        <MenuItem
                          value={ShopCreateRequestCategoryEnum.Japanese}
                        >
                          일식
                        </MenuItem>
                        ...
                        <MenuItem
                          value={ShopCreateRequestCategoryEnum.Fastfood}
                        >
                          패스트푸드
                        </MenuItem>
                        <MenuItem
                          value={ShopCreateRequestCategoryEnum.StewSoup}
                        >
                          찌개/국물
                        </MenuItem>
                  ...
                  <Stack direction="row" spacing={3}>
                    ...
                    <TextField
                      ...
                      InputProps={{
                        endAdornment: (
                          <Typography variant="caption">원</Typography>
                        ),
                      }}
                    />
                  </Stack>
